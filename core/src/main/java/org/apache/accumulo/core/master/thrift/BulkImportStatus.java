...
public class BulkImportStatus implements org.apache.thrift.TBase<BulkImportStatus, BulkImportStatus._Fields>, java.io.Serializable, Cloneable, Comparable<BulkImportStatus> {
  ...
  public BulkImportStatus setFilename(@org.apache.thrift.annotation.Nullable java.lang.String filename) {
    this.filename = filename;
    return this;
  }
   ...
   * @see BulkImportState
   */
  public BulkImportStatus setState(@org.apache.thrift.annotation.Nullable BulkImportState state) {
    this.state = state;
    return this;
  }
